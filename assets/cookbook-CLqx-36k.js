import{g as i,l as c}from"./utils-BbzRrZhm.js";const l=i("user");l||(window.location.href="/cookbook/src/pages/login.html");c();r();function r(){const t=JSON.parse(localStorage.getItem("my-cookbook"))||[],e=document.getElementById("cookbook-list");if(e){if(t.length===0){e.innerHTML="<p>You have no saved recipes.</p>";return}e.innerHTML=t.map(o=>`
